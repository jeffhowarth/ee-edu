...
Often, rare elements on the landscape are small in size. So by selecting habitat blocks that are greater than 100 acres, we may show bias to rare elements of the landscape and under-represent them in our conservation plan, essentially making poverty traps for rare but significant natural communities. 
...
| 1         | Habitat blocks but not a valley bottom.   |  
| 2         | Habitat connector (valley bottoms that are not habitat blocks).   |  
